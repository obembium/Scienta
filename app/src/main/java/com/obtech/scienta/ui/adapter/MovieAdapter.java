...
public class MovieAdapter extends RecyclerView.Adapter<com.obtech.scienta.ui.adapter.MovieAdapter.MovieViewHolder> {
    private static final String TAG = com.obtech.scienta.ui.adapter.MovieAdapter.class.getSimpleName();
